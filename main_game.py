...
class Player(arcade.Sprite):
    ...
    def jump_duck(self):
        if LeapsAndBoundsGame.down_up[0] == 1:
            pass
        elif LeapsAndBoundsGame.down_up[1] == 1:
            if self.center_y == GRASS_TOP + PLAYER_HEIGHT * PLAYER_SCALE / 2:
                self.change_y = PLAYER_JUMP_SPEED
        elif LeapsAndBoundsGame.down_up[0] == 0:
            pass
        elif LeapsAndBoundsGame.down_up[1] == 0:
            self.change_y = 0
...
class LeapsAndBoundsGame(arcade.Window):
    ...
    def setup(self):
        ...
        LeapsAndBoundsGame.down_up = [0, 0]
    ...
    def on_key_release(self, symbol: int, modifiers: int):
        ...
        if symbol == arcade.key.DOWN or symbol == arcade.key.S or symbol == arcade.key.LCTRL:
            LeapsAndBoundsGame.down_up[0] = 0
        if symbol == arcade.key.UP or symbol == arcade.key.W or symbol == arcade.key.SPACE:
            LeapsAndBoundsGame.down_up[1] = 0
